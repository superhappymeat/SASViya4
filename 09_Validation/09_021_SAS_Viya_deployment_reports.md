...
# SAS Viya Deployment Reports

* [Clone the GitHub project](#clone-the-github-project)
* [Install pre-reqs](#install-pre-reqs)
* [Run Viya ARK to create deployment reports](#run-viya-ark-to-create-deployment-reports)
...
## Run Viya ARK to create deployment reports
...
* Review the usage options and then run the tool to generate the deployment report
...
* Run the commands below to make the report easily available in the web browser.
    ...
    ln -s viya_deployment_report_*.html deploymentreport.html
    # print report URL
    printf "####\nto access the report from your browser, the url will be:
        http://$(hostname -f):1234/deploymentreport.html
    ###\n"
...
Now, you can open the provided URL in the web browser on the RACE Client machine.

Review the post installation report to see what has been deployed in the namespace.

![deployment report](img/deployment-report.png)
...
* [09 Validation / 09 021 SAS Viya deployment reports](/09_Validation/09_021_SAS_Viya_deployment_reports.md)**<-- you are here**

...
In the last lab, see [here](./11_310_Using_the_DO_with_a_Git_Repository.md), you used the operator with a Git repository, to deploy a Viya environment and then upgrade it.
...
Click [here](./11_330_Using_the_Orchestration_Tool.md) to move onto the next exercise: ***11_330_Using_the_Orchestration_Tool.md***
...
* [11 320 Using the Deployment Operator with an inline configuration](./11_320_Using_an_inline_configuration.md) **<-- You are here**

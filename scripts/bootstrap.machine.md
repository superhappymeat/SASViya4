...
```bash
curl -fsSL https://gelgitlab.race.sas.com/GEL/utilities/raceutils/raw/master/bootstrap/bootstrap.collection.sh | sed 's|_BREAK_|_NOBREAK_|g' | \
    sudo bash -s enable https://gelgitlab.race.sas.com/GEL/workshops/PSGEL255-deploying-viya-4.0.1-on-kubernetes.git azu_coll_fixes
...
ansible all -m shell -a "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.00.id.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.01.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.02.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.03.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.04.1.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.04.2.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.05.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.06.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.07.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.08.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.09.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.10.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.11.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.12.A.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.12.B.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.13.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.14.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.15.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.16.*.sh start"
sudo -u root bash -c "bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.17.*.sh start"


cat /opt/raceutils/.id.txt

ansible sasnode* -m shell -a "curl -fsSL https://gelgitlab.race.sas.com/GEL/utilities/raceutils/raw/master/bootstrap/bootstrap.collection.sh | sed 's|_BREAK_|_NOBREAK_|g'  |  sudo bash -s enable https://gelgitlab.race.sas.com/GEL/workshops/PSGEL255-deploying-viya-4.0.1-on-kubernetes.git azu_coll_fixes "

ansible sasnode* -m shell -a "curl -fsSL https://gelgitlab.race.sas.com/GEL/utilities/raceutils/raw/master/bootstrap/bootstrap.collection.sh | sed 's|_BREAK_|_NOBREAK_|g'  |  sudo bash -s start "

ansible sasnode* -b -m shell -a 'bash -x /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/GEL.00.id.sh start'

ansible sasnode* -m shell -a "cd ~/PSGEL255-deploying-viya-4.0.1-on-kubernetes/ ; git fetch --all ;     git reset --hard origin/azu_coll_fixes "

sudo -u cloud-user bash -c "ansible-playbook /home/cloud-user/PSGEL255-deploying-viya-4.0.1-on-kubernetes/scripts/loop/generate_RKE_Cluster_file_azu.yaml"
```
